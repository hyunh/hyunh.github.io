...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.b32baf2440369461815b08ae2180dd93a15ff379161816125099d86447e4d961.js',function(){input.required=false;search();});}
